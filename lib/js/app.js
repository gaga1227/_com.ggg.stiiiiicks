	...
	App.view = {
		...
		updateHintSticksOnTouch: function (e) {
			...
			if (e.type === 'touchstart') {
				...
				this.hintData.hintTimeout = setTimeout(_.bind(function () {
			...
			// check/update hints on touch move
				...
				clearTimeout(this.hintData.hintTimeout);

				// apply touchmove logics only when hint is active
				if (this.hintData.isActive) {

...
window.App = (function (app) {
	...
	App.view = {
		...
		updateDifficulty: function () {
			...
			// keep difficulty
			else if (App.data.game.stiiiiicks < 30) {
				App.data.game.scrambleMoves = 1;
			}
			// advance difficulty
			else if (App.data.game.stiiiiicks < 90) {
			...
			// advance difficulty
			else if (App.data.game.stiiiiicks < 180) {
			...
			// advance difficulty
			else if (App.data.game.stiiiiicks < 390) {
		...
		updateScoreText: function () {
			...
			if (('' + App.data.game.stiiiiicks) !== $score.text()) {

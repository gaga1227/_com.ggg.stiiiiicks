		...
		updateMoveHintOnTouch: function (e) {
			...
			if (e.type === 'touchstart') {
				...
				this.hintData.moveHintTimeout = setTimeout(_.bind(function () {
					...
					this.hintData.touchMoveAnchorX = e.originalEvent.touches[0].clientX;
			...
			// check/update hints on touch move
				...
				if (this.hintData.moveHintIsActive) {
					// get touch move data
					var diff = e.originalEvent.touches[0].clientX - this.hintData.touchMoveAnchorX;
					var cssProps = {
						x: diff
					};
					// update transform on sticks
					TweenLite.to(this.sticksData[0].$el[0], 0, cssProps);
				}
			}
				...
				if (this.hintData.moveHintIsActive) {
					...
					var cssProps = {
						...
						onComplete: _.bind(function () {
							...
							this.sticksData[0].$el.css({
								'transform': 'none'
							});
						}, this)
					};
					TweenLite.to(this.sticksData[0].$el[0], this.animSpeed.norm, cssProps);
				}
			}
		},

window.App = (function (app) {
	...
	App.view = {
		...
		initHammer: function () {
			...
			// add events handler
			this.hammer
				.off('tap doubletap press swipe')
				.on('tap doubletap press swipe', _.bind(function (e) {
		...
		updateDifficulty: function () {
			...
			// keep difficulty
			else if (App.data.game.stiiiiiicks < 30) {
				App.data.game.scrambleMoves = 1;
			}
			// advance difficulty
			else if (App.data.game.stiiiiiicks < 90) {
			...
			// advance difficulty
			else if (App.data.game.stiiiiiicks < 180) {
			...
			// advance difficulty
			else if (App.data.game.stiiiiiicks < 390) {
			...
			console.log('[Total Alignment]: ', App.data.game.totalAlignments);
			console.log('[StiiiiiickS]: ', App.data.game.stiiiiiicks);
		...
		updateScoreText: function () {
			...
			if (('' + App.data.game.stiiiiiicks) !== $score.text()) {
				$score.text(App.data.game.stiiiiiicks);
